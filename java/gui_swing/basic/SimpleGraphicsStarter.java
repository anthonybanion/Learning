...
public class SimpleGraphicsStarter extends JPanel {
    ...
    public static void main(String[] args) {
         ...
         */
        SimpleGraphicsStarter drawingArea = new SimpleGraphicsStarter();  // The drawing area.

        drawingArea.setBackground(Color.WHITE);  // Set background color for the picture.
        window.setContentPane(drawingArea);  // Show the drawing area in the window.
        ...
        window.pack();  // Set the size of the window based on the preferred size of its contents.
        window.setLocation(100,50);  // Set the location of the window on the screen.
        window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  // End program if window is closed.
