package projects.small_projects.student_manager.src.database;
...
public class DatabaseConnection {
    ...
    public DatabaseConnection() {
        ...
        try (FileInputStream input = new FileInputStream("projects/small_projects/student_manager/src/database/DBconfiguration.properties")) {
